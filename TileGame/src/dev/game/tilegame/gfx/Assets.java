...
public class Assets {
  ...
  //private static final int PLAYER_WIDTH = 110,PLAYER_HEIGHT = 115,PLAYER_GAP_X = 50,
  // PLAYER_START_X=20,PLAYER_START_Y=160;
  private static final int PLAYER_WIDTH = 68, PLAYER_HEIGHT = 80, PLAYER_GAP_X = 35,
          PLAYER_START_X = 20;
  ...
  public static void init() {
    //SpriteSheet playerSheet = new SpriteSheet(ImageLoader.loadImage
    // ("/resources/textures/sprites_mvc2_psylocke.png"));

    SpriteSheet backgroundSheet = new SpriteSheet(ImageLoader.loadImage
            ("/resources/textures/backgrounds.png"));
    SpriteSheet treeSheet = new SpriteSheet(ImageLoader.loadImage("/resources/textures/trees1" +
            ".png"));
    SpriteSheet rockSheet = new SpriteSheet(ImageLoader.loadImage("/resources/textures/rock4.png"));
    SpriteSheet playerSheet = new SpriteSheet(ImageLoader.loadImage
            ("/resources/textures/blond-girl.png"));

    SpriteSheet menuSheet = new SpriteSheet(ImageLoader.loadImage("/resources/ui/menu.png"));
    ...
    for (int i = 0; i < player_still.length; i++) {
      player_still[i] = playerSheet.crop(PLAYER_WIDTH * i, PLAYER_HEIGHT * 2, PLAYER_WIDTH,
              PLAYER_HEIGHT);
    }
    ...
    start_button[0] = menuSheet.crop(0,0,100,50);
    start_button[1] = menuSheet.crop(0,50,100,50);
